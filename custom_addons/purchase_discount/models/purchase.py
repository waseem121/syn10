...
class PurchaseOrderLine(models.Model):
    ...
    discount_amount_item = fields.Float(
        string='Disc Amount', store=True,digits=(12, 10))
    discount_share = fields.Float(string='Share Discount', store=True,digits=(12, 10))
    dis_share = fields.Float(string='share Discount per(%)', store=True,digits=(12, 10))

...
//	    },
	...
	screens.ProductScreenWidget.include({
		...
		start: function(){
			...
			$('button.captain_button').click(function(){
				self.gui.show_screen('clientlist');
			});
			/* datepicker hide */
...
//				}
			...
			$('#captain_screen').click(function(){
				self.gui.show_screen('captain_list');
			});
...
//	                                    }
		...
		show: function(){
			...
			if(client){
				$('.set-captain').html(client.name);
			}else{
				$('.set-captain').html("Captain");
			}                        

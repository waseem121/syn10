...
class StockPackOperationLot(models.Model):
    ...
    def create(self, vals):
        if vals.get('removal_date',False) and vals.get('life_date',False):
            if vals['removal_date'] > vals['life_date']:
                raise ValidationError(_('"Manufacture Date" must be less than "Expiry Date"'))
